...
export async function Navbar() {
  ...
  return(
    <nav className="sticky flex flex-col max-w-full h-max z-10 top-0 inset-x-o px-10 py-5 border-none bg-pink-800/100 text-slate-100  dark:bg-slate-800/50 backdrop-blur-xl  shadow-md ">
